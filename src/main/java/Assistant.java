...
public class Assistant extends Account
{
    ...
    protected static ArrayList <TeacherRequest> allProfessorRequests = new ArrayList <> ();
    ...
    */
    ...
    public static void viewProfessorRequests ()
    {
        ...
        for (TeacherRequest professorRequest : allProfessorRequests)
        {
        ...
        TeacherRequest professorRequest = TeacherRequest.findRequest (requestName);

        assert professorRequest != null;
        Teacher professor = new Teacher(professorRequest.userName, professorRequest.owlmail, professorRequest.password, professorRequest.fullName);
        Teacher.teachers.add (professor);
    ...
    public static void createCourse ()
    {
        ...
        while (Teacher.findProfessorByName (fullName) == null)
        {
        ...
        Teacher professor = Teacher.findProfessorByName (fullName);
    ...
    public static void viewAllProfessors ()
    {
        ...
        for (Teacher professor : Teacher.teachers)
        {
            if (professor != null)
            {
    ...
    public static void removeProfessor ()
    {
        ...
        Teacher professor = Teacher.findProfessorByName (fullName);
        Teacher.teachers.remove (professor);
