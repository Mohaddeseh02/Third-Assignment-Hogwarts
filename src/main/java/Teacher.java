...
public class Teacher extends Account
{
    ...
    protected static ArrayList <String> Owlmails = new ArrayList <> ();
    protected static ArrayList <String> Passwords = new ArrayList <> ();
    protected static ArrayList <UUID> AccountIDs = new ArrayList <> ();
    protected static ArrayList <String> FullNames = new ArrayList <> ();
    ...
    */
    ...
    protected Teacher(String userName, String owlmail, String password, String fullName)
    {
        ...
        Teacher.UserNames.add (userName);
        Teacher.Owlmails.add (owlmail);
        Teacher.Passwords.add (password);
        Teacher.FullNames.add (fullName);

        this.accountID = UUID.randomUUID ();
        Teacher.AccountIDs.add (accountID);
    }
    ...
    */
    ...
    public void accountSetting (Teacher professor)
    {
    ...
    public void changeUsername (Teacher professor)
    {
        System.out.println (skipLine); //clears the terminal screen
    ...
    public void changePassword (Teacher professor)
    {
        System.out.println (skipLine); //clears the terminal screen
        ...
        for (int i = 0; i < Passwords.size (); i++)
        {
            if (password.equals (Passwords.get (i)))
            {
                Passwords.set (i, hashPassword (firstPassword, professor.salt));
            }
        }
    ...
    public void changeOwlmail (Teacher professor)
    {
        System.out.println (skipLine); //clears the terminal screen
    ...
    public static Teacher findProfessorByOwlmail (String owlmail)
    {
    ...
    public static Teacher findProfessorByName (String fullName)
    {
        for (Teacher professor : teachers)
        {
    ...
    */
    ...
    public void takeCourse (Teacher professor)
    {
        System.out.println (skipLine); //clears the terminal screen
    ...
    */
    ...
    public static int validateUserName (String userName)
    {
        ...
        if (Teacher.UserNames.isEmpty ())
        {
            return 1;
        }

        String[] allUserNamesArray = new String[Teacher.UserNames.size ()];
        Teacher.UserNames.toArray (allUserNamesArray);
    ...
    public static int validateOwlmail (String owlmail)
    {
        ...
        if (Teacher.Owlmails.isEmpty ())
        {
            return 1;
        }
        else
        {
            String[] allOwlmailsArray = new String[Teacher.Owlmails.size ()];
            Teacher.Owlmails.toArray (allOwlmailsArray);
    ...
    public static int findUserNumber (String owlmail)
    {
        ...
        for (int i = 0; i < Teacher.Owlmails.size (); i++)
        {
    ...
    {
        String[] allPasswordsArray = new String[Teacher.Passwords.size ()];
        Teacher.Passwords.toArray (allPasswordsArray);
